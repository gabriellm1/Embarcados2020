...
module niosLab2_mm_interconnect_0 (
	...
	wire  [18:0] pio_motor_s1_agent_m0_address;                                                      // PIO_MOTOR_s1_agent:m0_address -> PIO_MOTOR_s1_translator:uav_address
	...
	wire  [95:0] pio_motor_s1_agent_rf_source_data;                                                  // PIO_MOTOR_s1_agent:rf_source_data -> PIO_MOTOR_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_motor_s1_agent_rsp_fifo_out_data;                                               // PIO_MOTOR_s1_agent_rsp_fifo:out_data -> PIO_MOTOR_s1_agent:rf_sink_data
	...
	wire         cmd_mux_004_src_valid;                                                              // cmd_mux_004:src_valid -> PIO_MOTOR_s1_agent:cp_valid
	wire  [94:0] cmd_mux_004_src_data;                                                               // cmd_mux_004:src_data -> PIO_MOTOR_s1_agent:cp_data
	wire         cmd_mux_004_src_ready;                                                              // PIO_MOTOR_s1_agent:cp_ready -> cmd_mux_004:src_ready
	wire   [5:0] cmd_mux_004_src_channel;                                                            // cmd_mux_004:src_channel -> PIO_MOTOR_s1_agent:cp_channel
	wire         cmd_mux_004_src_startofpacket;                                                      // cmd_mux_004:src_startofpacket -> PIO_MOTOR_s1_agent:cp_startofpacket
	wire         cmd_mux_004_src_endofpacket;                                                        // cmd_mux_004:src_endofpacket -> PIO_MOTOR_s1_agent:cp_endofpacket
	...
	wire  [95:0] pio_switches_s1_agent_rf_source_data;                                               // PIO_SWITCHES_s1_agent:rf_source_data -> PIO_SWITCHES_s1_agent_rsp_fifo:in_data
	...
	wire  [95:0] pio_switches_s1_agent_rsp_fifo_out_data;                                            // PIO_SWITCHES_s1_agent_rsp_fifo:out_data -> PIO_SWITCHES_s1_agent:rf_sink_data
	...
	wire  [94:0] cmd_mux_005_src_data;                                                               // cmd_mux_005:src_data -> PIO_SWITCHES_s1_agent:cp_data
	...
	wire         pio_motor_s1_agent_rp_valid;                                                        // PIO_MOTOR_s1_agent:rp_valid -> router_006:sink_valid
	wire  [94:0] pio_motor_s1_agent_rp_data;                                                         // PIO_MOTOR_s1_agent:rp_data -> router_006:sink_data
	wire         pio_motor_s1_agent_rp_ready;                                                        // router_006:sink_ready -> PIO_MOTOR_s1_agent:rp_ready
	wire         pio_motor_s1_agent_rp_startofpacket;                                                // PIO_MOTOR_s1_agent:rp_startofpacket -> router_006:sink_startofpacket
	wire         pio_motor_s1_agent_rp_endofpacket;                                                  // PIO_MOTOR_s1_agent:rp_endofpacket -> router_006:sink_endofpacket
	...
	wire  [94:0] pio_switches_s1_agent_rp_data;                                                      // PIO_SWITCHES_s1_agent:rp_data -> router_007:sink_data
	...
	wire         pio_motor_s1_agent_rdata_fifo_src_valid;                                            // PIO_MOTOR_s1_agent:rdata_fifo_src_valid -> avalon_st_adapter_004:in_0_valid
	wire  [33:0] pio_motor_s1_agent_rdata_fifo_src_data;                                             // PIO_MOTOR_s1_agent:rdata_fifo_src_data -> avalon_st_adapter_004:in_0_data
	wire         pio_motor_s1_agent_rdata_fifo_src_ready;                                            // avalon_st_adapter_004:in_0_ready -> PIO_MOTOR_s1_agent:rdata_fifo_src_ready
	wire         avalon_st_adapter_004_out_0_valid;                                                  // avalon_st_adapter_004:out_0_valid -> PIO_MOTOR_s1_agent:rdata_fifo_sink_valid
	wire  [33:0] avalon_st_adapter_004_out_0_data;                                                   // avalon_st_adapter_004:out_0_data -> PIO_MOTOR_s1_agent:rdata_fifo_sink_data
	wire         avalon_st_adapter_004_out_0_ready;                                                  // PIO_MOTOR_s1_agent:rdata_fifo_sink_ready -> avalon_st_adapter_004:out_0_ready
	wire   [0:0] avalon_st_adapter_004_out_0_error;                                                  // avalon_st_adapter_004:out_0_error -> PIO_MOTOR_s1_agent:rdata_fifo_sink_error
